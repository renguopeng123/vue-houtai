 ...
 * 使用例子:
 * ToolsController.getEnum('cn.gwssi.ecloudbpm.sys.persistence.enums.FieldControlType').then(function(data) {
 * 	$scope.FieldControlType = data; 
 * });
 * ToolsController.getEnum('cn.gwssi.ecloudbpm.base.db.model.Column$TYPE').then(function(data) {
 * 	$scope.ColumnTYPE = data; 
 * });
 * 注意！！如果枚举在类中间，那么路径如下：cn.gwssi.ecloudbpm.base.db.model.Column$TYPE
 * </pre>
 */
