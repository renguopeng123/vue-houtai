...
app.controller('ctrl', [ '$scope', 'baseService', 'ArrayToolService', '$filter', function($scope, baseService, ArrayToolService, $filter) {
	...
	$scope.init = function() {
		...
		ToolsController.getEnum("cn.gwssi.ecloudbpm.bus.api.constant.BusColumnCtrlType").then(function(data) {
			$scope.FieldControlType = data;
		});
		ToolsController.getEnum("cn.gwssi.ecloudbpm.base.api.constant.ColumnType").then(function(data) {
