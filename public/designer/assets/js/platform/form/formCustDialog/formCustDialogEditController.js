...
app.controller('ctrl', [ '$scope', 'baseService', 'ArrayToolService', '$filter', function($scope, baseService, ArrayToolService, $filter) {
	...
	$scope.init = function() {
		...
		ToolsController.getEnum("cn.gwssi.ecloudbpm.form.api.constant.FormCustDialogStyle").then(function(data) {
		...
		ToolsController.getEnum("cn.gwssi.ecloudbpm.form.api.constant.FormCustDialogObjType").then(function(data) {
			$scope.$apply(function() {
